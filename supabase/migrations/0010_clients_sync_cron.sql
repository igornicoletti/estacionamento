...
revoke execute on function public.remove_clients_sync_cron() from public, anon, authenticated;
revoke execute on function public.configure_clients_sync_cron(text, text, text, text) from public, anon, authenticated;
