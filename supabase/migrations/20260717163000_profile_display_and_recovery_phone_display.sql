...
comment on column public.access_recovery_requests.phone_display is
  'Telefone formatado informado na solicitação de recuperação, visível apenas para papéis autorizados pela RLS da tabela.';
