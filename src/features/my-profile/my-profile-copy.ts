export const myProfileCopy = {
  ...
  photoDialog: {
    ...
    description: "Escolha uma imagem para ser exibida na sua conta.",
    previewTitle: "Clique para escolher uma nova foto",
    dropTitle: "Selecione uma imagem",
    dropDescription: "PNG, JPG ou WebP até 5 MB",
    selectFile: "A área inteira abre o seletor de arquivos.",
