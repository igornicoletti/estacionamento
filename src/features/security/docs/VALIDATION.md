...
- [x] Score derivado apenas de medidas suportadas pelo projeto.
- [x] Medidas de senha forte, passkey e contato de recuperação renderizadas.
- [x] Ações reais: alterar senha, cadastrar/gerar passkey e atualizar contato no perfil.
