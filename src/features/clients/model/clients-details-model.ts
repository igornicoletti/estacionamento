...
function mapYesNoToStatus(value: boolean) {
  return value
...
export function getClientDetailItems(
  client: ClientTableRow
): readonly AppDetailsSheetItem[] {
  return [
    { label: clientsCopy.table.customerCode, value: client.cod_pessoa },
    {
      label: clientsCopy.table.legalName,
      value: emptyFallback(client.nom_pessoa),
    },
    {
      label: clientsCopy.table.tradeName,
      value: emptyFallback(client.nom_fantasia),
    },
    {
      label: clientsCopy.table.document,
    ...
    {
      label: clientsCopy.table.email,
      value: emptyFallback(client.des_email_1),
    },
    {
      label: clientsCopy.table.phone,
      value: formatClientPhone(
        client.num_telefone_1,
        clientsCopy.shared.emptyValue
      ),
    },
    {
      label: clientsCopy.table.cityState,
      value: formatClientCityState(
        client,
        clientsCopy.shared.emptyValue
      ),
    },
    {
      label: clientsCopy.table.registrationDate,
    ...
    {
      label: clientsCopy.table.status,
      value: mapActiveStatus(client.ind_pessoa_ativa),
    },
    {
      label: clientsCopy.table.financialBlock,
      value: mapYesNoToStatus(client.bloqueio_financeiro),
    },
    { label: clientsCopy.table.vehicles, value: client.qtd_veiculos },
    {
      label: clientsCopy.table.lastPurchase,
      value: formatClientDate(
        client.dta_ultima_compra,
        clientsCopy.shared.emptyValue
      ),
    },
  ]
...
export function getClientVehicleDetailItems(
  ...
  return [
    ...
    {
      label: clientsCopy.table.legalName,
      value: emptyFallback(vehicle.nom_pessoa),
    },
    {
      label: clientsCopy.table.tradeName,
      value: emptyFallback(vehicle.nom_fantasia),
    },
    {
      label: clientsCopy.table.document,
      value: formatClientDocument(
        vehicle.num_cnpj_cpf,
        clientsCopy.shared.emptyValue
      ),
    },
    { label: clientsCopy.table.plate, value: emptyFallback(vehicle.num_placa) },
    {
      label: clientsCopy.table.vehicle,
      value: emptyFallback(vehicle.des_veiculo),
    },
    {
      label: clientsCopy.table.driver,
      value: emptyFallback(vehicle.nom_motorista),
    },
  ]
}
