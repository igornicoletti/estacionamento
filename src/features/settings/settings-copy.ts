export const settingsCopy = {
  ...
  security: {
    ...
    credentialsTitle: "Credencial de acesso",
    credentialsDescription:
      "Estado da passkey cadastrada para autenticação neste usuário.",
    ...
    noPermissions: "Nenhuma permissão explícita vinculada à sessão.",
