...
export const accessRequestsCopy = {
  ...
  verification: {
    accountFound: "Conta localizada",
    accountNotFound: "Conta não localizada",
    contactMatched: "Contato confere",
    contactMismatch: "Contato divergente",
    emailMatched: "E-mail confere",
    emailMismatch: "E-mail não confere",
    emailNotProvided: "E-mail não informado",
    phoneMatched: "Telefone confere",
    phoneMismatch: "Telefone não confere",
