export const authCopy = {
  validation: {
    ...
    recoveryDescriptionRequired: "Informe o motivo.",
    recoveryDescriptionMax: "O motivo deve ter no máximo 500 caracteres.",
  },
  errors: {
  ...
  recovery: {
    ...
    descriptionLabel: "Motivo detalhado",
    descriptionPlaceholder: "Descreva o motivo da recuperação.",
