export const rulesCopy = {
  ...
  labels: {
    ...
    client: "Cliente",
    emptyValue: "—",
    fuelBenefit: "Isenção por abastecimento",
    inactive: "Inativa",
    network: "Rede",
  ...
  form: {
    ...
    targetType: "Aplicar regra VIP para",
    scope: "Abrangência",
    clientId: "Código do cliente",
    ...
    yardStaleVehicleAmount: "Tempo sem saída",
    ...
    vehiclePlaceholder: "Selecione o veículo",
    vehicleEmpty: "Nenhum veículo encontrado.",
