...
export const unitYardConfigSchema = z.object({
  ...
  parkingSpots: z.number({ error: unitsCopy.yard.validationInvalidSpots }).int({ error: unitsCopy.yard.validationInvalidSpots }).min(0, { error: unitsCopy.yard.validationInvalidSpots }),
})

export type UnitYardConfigFormValues = z.infer<typeof unitYardConfigSchema>

export function validateUpsertUnitYardConfigInput(input: UpsertUnitYardConfigInput): UpsertUnitYardConfigInput {
