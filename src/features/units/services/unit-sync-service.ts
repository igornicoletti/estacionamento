...
export async function triggerUnitsSync(mode: UnitSyncMode = "incremental"): Promise<TriggerUnitsSyncResult> {
...
async function executeUnitSync(mode: UnitSyncMode): Promise<TriggerUnitsSyncResult> {
