...
export function SidebarProfile() {
  ...
  return (
    <div className="px-3 py-2 group-data-[collapsible=icon]:flex group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0">
      <div className="flex items-center gap-2 rounded-lg border border-primary/20 bg-primary/10 px-3 py-1.5 text-xs font-bold text-primary uppercase group-data-[collapsible=icon]:h-9 group-data-[collapsible=icon]:w-9 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:py-0">
        <ShieldIcon className="size-4 shrink-0" />
        <span className="truncate text-xs font-bold group-data-[collapsible=icon]:hidden">
          {label}
        </span>
      </div>
    </div>
